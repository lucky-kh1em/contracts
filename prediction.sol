...
contract PredictionPool is ReentrancyGuard, Ownable {
  ...
  uint256 public depositDuration = 5 minutes;
  uint256 public lockDuration = 5 minutes;
  uint256 public withdrawFee = 500; // /10000
  address public devAddress = 0xeA750480CAAFe7C19b9C0302b180112347b168F8;
    ...
    onlyOwner
  {
    ...
    pool.lpToken.safeIncreaseAllowance(address(masterchef), type(uint256).max);
  }
